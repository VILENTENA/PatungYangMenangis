...
let currentLanguage = 'kd'; // CHANGED: Default to 'kd' (Bahasa Kadazandusun)
...
const createPlaybackControls = () => {
  ...
  // 4. Language Cycle Button (Updated Default to KD)
  const btnLang = document.createElement("button");
  btnLang.className = "control-button";
  btnLang.innerText = "KD"; // CHANGED: Default display
  btnLang.style.fontWeight = "bold";
  btnLang.onclick = (e) => {
    e.stopPropagation();
    // Cycle Language: KD -> EN -> BM -> KD
